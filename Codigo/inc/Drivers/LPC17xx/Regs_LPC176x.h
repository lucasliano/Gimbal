...
//!< ////////////////// REGISTROS GPIOs //////////////////////////////
//!< 0x2009C000UL : Dirección de inicio de los registros de GPIOs
#define	GPIOs		( ( registro  * ) 0x2009C000UL )

#define		PORT0		0//(GPIOs+0)		//!< 0x2009C000
#define		PORT1		1//(GPIOs+8)		//!< 0x2009C020
#define		PORT2		2//(GPIOs+16)		//!< 0x2009C040
#define		PORT3		3//(GPIOs+24)		//!< 0x2009C060
#define		PORT4		4//(GPIOs+32)		//!< 0x2009C080
